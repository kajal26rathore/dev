	    ...
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	        ...
	        <ul class="nav navbar-nav">
			 <li><a href="index.php"><b>Home</b></a></li>
			  <li class="dropdown">
		          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><b>Jobs</b><b class="caret">
				  </b></a>
		             <ul class="dropdown-menu">
			           
			            <li><a href="postjob.php"><b>Post a Job</b></a></li>
						 <li><a href="posted.php"><b>Find job</b></a></li>
			            <li><a href="jobs.html"><b>Other Detail</b></a></li>
		             </ul>
		        </li>
			 <li><a href="services.html"><b>Services</b></a></li>
		      
		        <li class="dropdown">
		          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><b>Recruiters</b><b class="caret">
				  </b></a>
		             <ul class="dropdown-menu">
			            <li><a href="location.html"><b>Recruiter location</b></a></li>
			            <li><a href="features.html"><b>Features</b></a></li>
			            <li><a href="following.html"><b>Followers</b></a></li>
		             </ul>
		        </li>
		        <li class="dropdown">
		            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><b>More</b><b class="caret"></b></a>
		            <ul class="dropdown-menu">
					<li><a href="manager.html"><b>Project Managers</b></a></li>
			            <li><a href="about.html"><b>About us</b></a></li>
			            <li><a href="contact.php"><b>Contact us</b></a></li>
			            <li><a href="terms.html"><b>Terms</b></a></li>
		            </ul>
		        </li>
		        <li><a href="resume.html"><b>Upload Resume</b></a></li>
	        </ul>
	    </div>
...
<div class="container">
  <div class="grid_1">
	 ...
	 <div class="single">  
	   <div class="col-md-6">
	   	  <div class="col_3" style="width:400px;">
	   	  	<h3>Todays Jobs</h3>
	   	  	<ul class="list_1">
